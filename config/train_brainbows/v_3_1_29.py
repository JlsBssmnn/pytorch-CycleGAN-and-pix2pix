...
class Config:
    ...
    dataset_transforms_A = [
        ...
        {'name': 'RandomOpening'},
        {'name': 'RandomClosing'},
        {'name': 'RandomGaussianBlur', 'channels': output_nc, 'kernel_size': [1, 3, 3], 'sigma_range': (0, 1, 0.1)},
    ...
    direction = 'AtoB'
    disc_transforms_A = [
        {'name': 'GaussianBlur', 'channels': output_nc, 'kernel_size': [1, 3, 3], 'sigma': 0.5},
    ]
    ...
    n_epochs_decay = 40
    n_layers_D = 5
    name = 'brainbows_v_3_1_29'
    ndf = 64
    netD = 'n_layers'
    netG = 'unet_32x64x64'
    ngf = 64
    no_adversarial_loss = True
    no_dropout = True
    no_flip = False
    no_html = False
