...
class Config:
    ...
    dataset_transforms_A = [
        {'name': 'RandomDiscreteRotation', 'angles': [0, 90, 180, 270], 'axes': ['xy']},
        {'name': 'RandomFlip', 'axes': ['xy']},
        {'name': 'ChannelModifier', 'target_channel_count': 2, 'mode': 'value', 'x': -1},
    ]
    ...
    n_epochs_decay = 50
    n_layers_D = 3
    name = 'epithelial_sheets_v_3_0_2'
    ndf = 64
    netD = 'basic'
    netG = 'unet_32x64x64'
    ngf = 64
    ...
    pool_size = 50
    post_transforms_A = [
        {'name' : 'Threshold', 'lower': -1, 'upper': 1},
    ]
