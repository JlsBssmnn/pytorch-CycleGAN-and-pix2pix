...
class EvaluationConfig:
    ...
    stride = (16, 32, 32)
    batch_size = 128
    basins_range = (150, 256, 5)
    membrane_range = (0, 100, 25)
    error_factor = 1/2
    show_progress = False
...
class Config:
    ...
    datasetA_mask = 'mask'
    datasetA_names = None
    datasetA_random_sampling = False
    datasetB_creation_func = None
    datasetB_file = 'epithelial_v_1_1_1.h5'
    datasetB_mask = None
    datasetB_names = None
    datasetB_random_sampling = False
    dataset_length = 'min'
    ...
    n_epochs_decay = 35
    n_layers_D = 3
    name = 'epithelial_sheets_v_4_0_35'
    ndf = 64
    netD = 'basic'
    netG = 'unet_32x64x64'
    ngf = 64
    no_adversarial_loss_A = True
    no_adversarial_loss_B = False
    no_dropout = True
    no_flip = False
    no_html = False
    ...
    num_threads = 1
    output_nc = output_nc
    partial_cycle_A = True
    partial_cycle_B = False
    phase = 'train'
    pool_size = 50
    post_transforms_A = [
